...
class Submit_2 extends StatefulWidget {
  const Submit_2({super.key});

  @override
  State<Submit_2> createState() => _Submit_2State();
}

class _Submit_2State extends State<Submit_2> {
  late Color myColor;
  late Size mediaSize;
  ...
  Widget _buildBottom(){
    return Column(
      ...
      children: [
        ...
        _buildGreyText("CE481 / 436A"),
        const SizedBox(height: 5),
        _buildGreyText("Computer and Robotics Engineering Project I"),
        const SizedBox(height: 5),
        _buildGreyText("Room B4-402 / No. 6"),
        const SizedBox(height: 15),
